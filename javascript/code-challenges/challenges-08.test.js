...
const sortByChildren = (charArray) => {
  return charArray.sort((a,b) => {
    //if both characters DO NOT have children, sort alphabetically by house name
    ...
    // if a has children and b does not have children, bring b forward
    else if (a.children && !b.children) {
      return 1;
    } 
    // if a does not have children and b has children, bring a forward
    else if (!a.children && b.children) {
      return -1;
    }
    // if both characters have children, sort by amount of children
    ...
    // if both characters have same amount of children, sort alphabetically by house name
    else if (a.children.length === b.children.length) {
      if (a.house < b.house) {
        return -1;
      } else if (a.house > b.house) {
